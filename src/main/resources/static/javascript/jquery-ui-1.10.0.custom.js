					...
					this._on( this.document, {
						focusin: function( event ) {
							if ( !$( event.target ).closest(".ui-dialog").length ) {
								...
								/*modified by quan 2013.10.10 17:04*/
								if(!!$(".ui-dialog:visible:last .ui-dialog-content").data("ui-dialog")) $(".ui-dialog:visible:last .ui-dialog-content").data("ui-dialog")._focusTabbable();
							}
						}
					});
				}
